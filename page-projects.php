...
<main>
	<article class="container py-5">
		<div class="svg-background d-flex flex-column gap-1">
			<svg class="svg-background--icon wordpress" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 512 512">
			...
			<svg class="svg-background--icon php" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 640 512">
			...
			<svg class="svg-background--icon bootstrap" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 576 512">
			...
			<svg class="svg-background--icon gulp" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 256 512">
				<!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
			...
			<svg class="svg-background--icon sass" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 640 512">
				<!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
		...
		<div class="content components">
			<section class="jumbotron mb-5 pb-3">
				<h1 class="mb-5 pb-3">Proficient in HTML5, CSS3,
					<span>PHP</span>, and
					<span>JavaScript</span>. I build digital products with a strong focus on user experience.
				</h1>


			</section>

			<section class="wysiwyg text-end">
			...
			<div class="mb-5 pb-5 ">
				...
				<div class="social-share d-flex column-gap-2 social-share--portfolio-magazine">

					<ul class="nav column-gap-3 ">
						<li class="nav-item">

							<a href="https://github.com/henzlym?tab=repositories" class="link_item">
								<span class="link_item_wrapper  d-flex icon-link">

									<svg class="bi" fill="currentColor">
										<use xlink:href="<?php echo get_template_directory_uri() . '/icons/icons.svg#github'; ?>"></use>
									</svg>
								</span>
							</a>
						</li>
						<li class="nav-item">
							...
							<a href="https://www.linkedin.com/in/henzly-meghie/" class="link_item">
								<span class="link_item_wrapper  d-flex icon-link">

									<svg class="bi" fill="currentColor">
										<use xlink:href="<?php echo get_template_directory_uri() . '/icons/icons.svg#linkedin'; ?>"></use>
									</svg>
								</span>
							</a>
						</li>
						<li class="nav-item">
							...
							<a href="https://tidal.com/browse/user/40855946" class="link_item">
								<span class="link_item_wrapper  d-flex icon-link">

									<svg class="bi" fill="currentColor">
										<use xlink:href="<?php echo get_template_directory_uri() . '/icons/icons.svg#headphones'; ?>"></use>
									</svg>
								</span>
							</a>
						</li>
