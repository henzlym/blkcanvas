				...
				<div class="row row-cols-1 row-cols-md-2 gy-2">
					<div class="col ">
						...
						<div class="gallery-item design">
							...
							<div class="mb-5">
								<h2 class="lh-base h4">
									<a href="<?php echo site_url( '/portfolio/maxim' ); ?>" class="text-reset">Maxim</a>
								</h2>
							...
							<a href="<?php echo site_url( '/portfolio/maxim' ); ?>" class="btn btn-outline-light">
								View Project
								<span class="ms-1">
					...
					<div class="col ">
						...
						<div class="gallery-item design">
							...
							<div class="mb-5">
								<h2 class="lh-base h4">
									<a href="<?php echo site_url( '/portfolio/sportsnaut' ); ?>" class="text-reset">Sportsnaut</a>
								</h2>
							...
							<a href="<?php echo site_url( '/portfolio/sportsnaut' ); ?>" class="btn btn-outline-light">
								View Project
								<span class="ms-1">
